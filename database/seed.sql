...
INSERT IGNORE INTO users (name, email, password_hash, role, theme_preference) VALUES
('Ganga Maxx Admin', 'admin@gangamaxx.com', '$2a$10$W8gFhG5xTfZ1TUD7ixKw8uQ6S1eUMDyrM6MG13fjzwEVavN/4q3eq', 'admin', 'dark');

INSERT IGNORE INTO customers (id, company_name, contact_name, email, phone, status) VALUES
...
INSERT IGNORE INTO credit_accounts (customer_id, credit_limit, outstanding_amount, status) VALUES
...
INSERT IGNORE INTO invoices (customer_id, invoice_no, invoice_date, due_date, total_amount, paid_amount, status) VALUES
(1, 'GMX-INV-1042', '2026-06-08', '2026-07-08', 186000, 0, 'open'),
(1, 'GMX-INV-1031', '2026-05-01', '2026-05-31', 338000, 90000, 'partial'),
(2, 'GMX-INV-1009', '2026-03-14', '2026-04-28', 812500, 200000, 'overdue'),
(3, 'GMX-INV-0988', '2026-03-07', '2026-03-28', 251250, 60000, 'overdue'),
(4, 'GMX-INV-1045', '2026-05-29', '2026-06-28', 329900, 113900, 'partial'),
(5, 'GMX-INV-0911', '2026-02-03', '2026-02-18', 203600, 60000, 'overdue');

INSERT IGNORE INTO payments (customer_id, invoice_id, amount, payment_method, reference_no, payment_date) VALUES
...
INSERT IGNORE INTO account_statements (customer_id, transaction_date, type, reference_no, description, debit, credit) VALUES
...
INSERT IGNORE INTO aging_reports (customer_id, invoice_id, invoice_no, due_date, days_overdue, bucket, priority, balance) VALUES
...
INSERT IGNORE INTO notifications (user_id, type, title, message, created_at) VALUES
