          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={revenue}>
                <defs>
                  <linearGradient id="collections" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#6366f1" stopOpacity={0.4} /><stop offset="95%" stopColor="#6366f1" stopOpacity={0} /></linearGradient>
                ...
                <Area type="monotone" dataKey="collections" stroke="#6366f1" strokeWidth={3} fill="url(#collections)" animationDuration={2000} animationEasing="ease-in-out" activeDot={<CustomActiveDot />} dot={{ r: 4, fill: '#6366f1', strokeWidth: 2, stroke: '#ffffff' }} filter="url(#shadow)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </motion.section>
